...
export function buildSameProductGallery(imageUrl, category = "상의", seedKey = "") {
  if (!imageUrl) return [];
...
export function buildFallbackGallery(imageUrl, category = "상의", seedKey = "") {
